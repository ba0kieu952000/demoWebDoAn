                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +84 033 491 4295</a></li>
                    ...
                    <div class="col-sm-4">
                        <div class="search_box pull-right">
                            <form action="{{URL::to('/tim-kiem')}}" method="POST">
                                ...
                                <button type="submit" name="timkiem_submit" class="btn btn-warning">Tìm</button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{URL::to('../public/frontend/images/3f26291b-2b2c-4a49-9fa3-136b5c0f3b7f_11763676208316-removebg-preview.png')}}" class="girl img-responsive" alt="" />
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{URL::to('../public/frontend/images/STAT-PSO002f-removebg-preview.png')}}" class="girl img-responsive" alt="" />
                                </div>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{URL::to('../public/frontend/images/6-removebg-preview.png')}}" class="girl img-responsive" alt="" />
                                </div>
                            </div>
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{URL::to('/DanhMucSanPham/'.$value->category_id)}}">{{$value->category_name}}</a></h4>
                                </div>
                            </div>
                            @endforeach
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><a href="{{URL::to('/ThuongHieuSanPham/'.$value->brand_id)}}"> <span class="pull-right">(50)</span>{{$value->brand_name}}</a></li>
                                </ul>
                            </div>
                            @endforeach
