        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
                ...
                <?php
                    if($value->brand_status==0){ ?>
                        <a href="{{URL::to('/active-brand-product/'.$value->brand_id)}}">
                            <span class='fa-thumb-styling fa fa-eye-slash'></span></a>
                <?php
                    }
                    else { ?>
                        <a href="{{URL::to('/unactive-brand-product/'.$value->brand_id)}}">
            ...
            <td>
              ...
              <a href="{{URL::to('/del-brand-product/'.$value->brand_id)}}" onclick="return confirm('Bạn có muốn xóa không?')" class="active styling-del" ui-toggle-class="">
