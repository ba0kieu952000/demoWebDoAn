        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
                ...
                <?php
                    if($value->category_status==0){ ?>
                        <a href="{{URL::to('/active-category-product/'.$value->category_id)}}">
                            <span class='fa-thumb-styling fa fa-eye-slash'></span></a>
                <?php
                    }
                    else { ?>
                        <a href="{{URL::to('/unactive-category-product/'.$value->category_id)}}">
            ...
            <td>
              ...
              <a href="{{URL::to('/del-category-product/'.$value->category_id)}}" onclick="return confirm('Bạn có muốn xóa không?')" class="active styling-del" ui-toggle-class="">
