                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_name" class="form-control" id="exampleInputName1" value="{{ $value->product_name }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName2">Giá sản phẩm:</label>
                                    <input type="text" name="product_price" class="form-control" id="exampleInputName2"value="{{ $value->product_price }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName3">Hình ảnh sản phẩm:</label>
                                    <input type="file" name="product_image" class="form-control" id="exampleInputName3">
                                    <img src="{{URL::to('../public/uploads/product/'.$value->product_image)}}" height="100" width="100" alt="">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName4">Mô tả sản phẩm:</label>
                                    <textarea class="ckeditor" style="resize: none" rows="5" name="product_desc" type="password" class="form-control" id="exampleInputName4">{{ $value->product_desc }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputName5">Nội dung sản phẩm:</label>
                                    <textarea class="ckeditor" style="resize: none" rows="5" name="product_content" type="password" class="form-control" id="exampleInputName5">{{ $value->product_content }}</textarea>
                                </div>
                                <div class="form-group">
